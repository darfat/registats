...
@Component
export default class CompetitionName extends mixins(Vue2Filters.mixin) {
  ...
  public mounted(): void {
    this.retrieveAllCompetitionNames();
  }
  ...
  public retrieveAllCompetitionNames(): void {
  ...
  public prepareRemove(instance: ICompetitionName): void {
    this.removeId = instance.id;
  }

  public removeCompetitionName(): void {
    this.competitionNameService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('registatsApp.competitionName.deleted', { param: this.removeId });
