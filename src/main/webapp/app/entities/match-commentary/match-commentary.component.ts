...
@Component
export default class MatchCommentary extends mixins(Vue2Filters.mixin) {
  ...
  public mounted(): void {
    this.retrieveAllMatchCommentarys();
  }
  ...
  public retrieveAllMatchCommentarys(): void {
  ...
  public prepareRemove(instance: IMatchCommentary): void {
    this.removeId = instance.id;
  }

  public removeMatchCommentary(): void {
    this.matchCommentaryService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('registatsApp.matchCommentary.deleted', { param: this.removeId });
