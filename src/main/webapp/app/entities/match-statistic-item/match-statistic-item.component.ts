...
@Component
export default class MatchStatisticItem extends mixins(Vue2Filters.mixin) {
  ...
  public mounted(): void {
    this.retrieveAllMatchStatisticItems();
  }
  ...
  public retrieveAllMatchStatisticItems(): void {
  ...
  public prepareRemove(instance: IMatchStatisticItem): void {
    this.removeId = instance.id;
  }

  public removeMatchStatisticItem(): void {
    this.matchStatisticItemService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('registatsApp.matchStatisticItem.deleted', { param: this.removeId });
