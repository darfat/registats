...
@Component
export default class CompetitionPlayerStatistic extends mixins(Vue2Filters.mixin) {
  ...
  public mounted(): void {
    this.retrieveAllCompetitionPlayerStatistics();
  }
  ...
  public retrieveAllCompetitionPlayerStatistics(): void {
  ...
  public prepareRemove(instance: ICompetitionPlayerStatistic): void {
    this.removeId = instance.id;
  }

  public removeCompetitionPlayerStatistic(): void {
    this.competitionPlayerStatisticService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('registatsApp.competitionPlayerStatistic.deleted', { param: this.removeId });
