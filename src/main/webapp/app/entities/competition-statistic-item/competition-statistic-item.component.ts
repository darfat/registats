...
@Component
export default class CompetitionStatisticItem extends mixins(Vue2Filters.mixin) {
  ...
  public mounted(): void {
    this.retrieveAllCompetitionStatisticItems();
  }
  ...
  public retrieveAllCompetitionStatisticItems(): void {
  ...
  public prepareRemove(instance: ICompetitionStatisticItem): void {
    this.removeId = instance.id;
  }

  public removeCompetitionStatisticItem(): void {
    this.competitionStatisticItemService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('registatsApp.competitionStatisticItem.deleted', { param: this.removeId });
