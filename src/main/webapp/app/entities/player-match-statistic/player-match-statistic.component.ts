...
@Component
export default class PlayerMatchStatistic extends mixins(Vue2Filters.mixin) {
  ...
  public mounted(): void {
    this.retrieveAllPlayerMatchStatistics();
  }
  ...
  public retrieveAllPlayerMatchStatistics(): void {
  ...
  public prepareRemove(instance: IPlayerMatchStatistic): void {
    this.removeId = instance.id;
  }

  public removePlayerMatchStatistic(): void {
    this.playerMatchStatisticService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('registatsApp.playerMatchStatistic.deleted', { param: this.removeId });
