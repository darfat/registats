...
import VenueComponent from '@/entities/venue/venue.vue';
import VenueClass from '@/entities/venue/venue.component';
...
describe('Component Tests', () => {
  describe('Venue Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<VenueClass>(VenueComponent, {
        store,
        i18n,
        localVue,
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(venueServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(venueServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
